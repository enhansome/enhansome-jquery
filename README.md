...
[<img src="https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg" alt="Awesome" height="18">](https://github.com/sindresorhus/awesome) ⭐ 505,114 | 🐛 106 | 📅 2026-09-02
...
[![Project Maintained](https://img.shields.io/badge/project-maintained-brightgreen.svg?style=plastic "Project Maintained")](https://github.com/petk/awesome-jquery/commits/master) ⭐ 978 | 🐛 0 | 📅 2026-01-01
...
* [TodoMVC](https://github.com/tastejs/todomvc) ⭐ 28,956 | 🐛 72 | 🌐 JavaScript | 📅 2026-06-06 - Helps you select JavaScript framework. Same Todo application created in multiple popular JavaScript MV\* frameworks including [jQuery](http://todomvc.com/examples/jquery/).
...
* [Fullpage.js](https://github.com/alvarotrigo/fullPage.js) ⭐ 35,389 | 🐛 129 | 🌐 JavaScript | 📅 2026-03-17 - Create full screen pages fast and simple.
* [jQuery Particles](https://github.com/matteobruni/tsparticles/tree/master/components/jquery) ⭐ 8,979 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-11 - A plugin to easily add Particles animations to your web application
...
* [Froala WYSIWYG HTML Editor](https://github.com/froala/wysiwyg-editor) ⭐ 5,400 | 🐛 426 | 🌐 CSS | 📅 2026-08-19 - jQuery WYSIWYG Rich Text Editor based on HTML5.
...
* [Select2](https://github.com/select2/select2) ⭐ 25,902 | 🐛 134 | 🌐 JavaScript | 📅 2026-09-11 - Select box with support for searching, tagging, remote data sets, infinite scrolling.
...
* [Bootstrap Multiselect](https://github.com/davidstutz/bootstrap-multiselect) ⭐ 3,678 | 🐛 314 | 🌐 HTML | 📅 2026-02-15 - Multiselect for Bootstrap.
...
* [BackStretch](https://github.com/jquery-backstretch/jquery-backstretch) ⭐ 3,880 | 🐛 216 | 🌐 JavaScript | 📅 2020-08-20 - jQuery plugin that allows you to add a dynamically-resized, slideshow-capable background image to any page or element.
...
* [Magnific Popup](https://github.com/dimsemenov/Magnific-Popup) ⭐ 11,311 | 🐛 678 | 🌐 JavaScript | 📅 2024-06-08 - Fast, light and responsive lightbox plugin.
...
* [Isotope](https://github.com/metafizzy/isotope) ⭐ 11,097 | 🐛 76 | 🌐 HTML | 📅 2021-09-24 - Filter & sort magical layouts.
...
* [Mockjax](https://github.com/jakerella/jquery-mockjax) ⭐ 2,086 | 🐛 9 | 🌐 JavaScript | 📅 2026-09-10 - Provides a simple and extremely flexible interface for mocking or simulating ajax requests and responses.
...
* [awesome-javascript](https://github.com/sorrycc/awesome-javascript) ⭐ 35,016 | 🐛 23 | 📅 2026-09-08 - Awesome JavaScript list
* [js-must-watch](https://github.com/bolshchikov/js-must-watch) ⭐ 13,611 | 🐛 0 | 📅 2022-01-20 - List of must-watch videos devoted to JavaScript
* [awesome-javascript-books](https://github.com/heatroom/awesome-javascript-books) ⭐ 130 | 🐛 1 | 📅 2018-10-13 - Awesome JavaScript books
* Awesome lists:
  * [awesome](https://github.com/sindresorhus/awesome) ⭐ 505,114 | 🐛 106 | 📅 2026-09-02 - Awesome lists
  * [lists](https://github.com/jnv/lists) ⭐ 11,473 | 🐛 27 | 📅 2026-03-23 - Awesome lists
...
You are most welcome to [contribute](CONTRIBUTING.md) to this awesome jQuery list as well. Big thanks to all [contributors](https://github.com/petk/awesome-jquery/graphs/contributors) ⭐ 978 | 🐛 0 | 📅 2026-01-01 who have helped to build this list.
